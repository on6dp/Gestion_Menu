...
cp -rf ${REP_COURANT}/${FIC_REF}_${INDICATIF}/dvsm.${INDICATIF} /opt/Analog_Bridge_${INDICATIF}/dvsm.macro
echo "cp -rf ${REP_COURANT}/${FIC_REF}_${INDICATIF}/dvsm.${INDICATIF} /opt/Analog_Bridge_${INDICATIF}/dvsm.macro"
