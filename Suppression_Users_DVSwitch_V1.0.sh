...
if (whiptail --title "F1PTL MENU Installation Users DVSwitch Version ${Version}" --yesno "Renseigner les informations demandees afin de mettre a jour tous les fichers d initialisations. Suppression de l indicatif, ID-DMR..." 8 78); then
