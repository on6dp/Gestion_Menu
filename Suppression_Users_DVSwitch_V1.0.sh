...
if (whiptail --title "F1PTL MENU Installation Users DVSwitch Version ${Version}" --yesno "Renseigner les informations demandees afin de mettre a jour tous les fichers d initialisations. Suppression d indicatif, ID-DMR..." 8 78); then
...
INDICATIF=$(whiptail --title "Input" --inputbox "Quel est l indicatif a supprimer ?" 10 60 FXXXX 3>&1 1>&2 2>&3)
exitstatus=$?
